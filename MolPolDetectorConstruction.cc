...
G4VPhysicalVolume* MolPolDetectorConstruction::Construct() {
  ...
  G4VSolid*        VBSolid2  = new G4Tubs("VBSolid",0,1.5*cm, VBSolidHLZ ,0.0,360.0*deg);
  ...
  G4LogicalVolume* Q4EXLogical = new G4LogicalVolume(VBSolid2, MolPol_Aluminum, "Q4EXLogical",0,0,0);
  ...
  Q4EXLogical->SetVisAttributes(CuVisAtt);
